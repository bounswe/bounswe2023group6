...
interface ReportRepository : JpaRepository<Report, Long>{
    ...
    fun findByReportedGameIsNotNull(): List<Report>
    fun findByReportedPostIsNotNull(): List<Report>
    fun findByReportedCommentIsNotNull(): List<Report>
    fun findByReportedLFGIsNotNull(): List<Report>
}
