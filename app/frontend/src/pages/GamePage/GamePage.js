					...
					<div className='w-full flex justify-center p-8 bg-neutral-50 pb-20'>
						<div className='w-9/10 flex flex-col'>
							<div className='flex m-4'>
								<p className='text-neutral-600 mt-4'>Page created on: October 15, 2023 by @fifaloverr</p>
							</div>
							<div className='w-full flex flex-row'>
									...
									<div className='card compact bg-neutral-200 text-cyan-700 shadow-xl m-2 p-4'>
										<div className='flex'>
											...
											<div className='w-3/5'>
												...
												<br />
												<p className='text-neutral-700 font-bold'>{game.releaseYear}</p>
											</div>
										</div>
									</div>
									<div className='w-full flex flex-row'>
										...
										<div className='w-1/2 card compact bg-neutral-200 text-cyan-700 shadow-xl m-1 p-4'>
											...
											<div className='flex flex-wrap'>
												<Link to='/genre/football' className='text-neutral-700 mr-4'>
													{game.genre}
												</Link>
											</div>
										</div>
								...
								<div className='w-2/5 flex flex-col'>
									<div className='h-full card compact bg-neutral-200 text-cyan-700 shadow-xl m-2 p-4'>
										...
										<p className='text-neutral-700 border-b-2 border-neutral-400 p-2'>Player number : {game.playerNumber}</p>
										<h2 className='text-xl font-bold p-2'>Platform:</h2>
										<p className='text-neutral-700 border-b-2 border-neutral-400 p-2'>{game.platform}</p>
										...
										{gamesmyliked.map((game) => (
											<li key={game.id} className='mb-2'>
												<button
													...
													className='text-neutral-700 mr-4'
												>
													{game.title}
												</button>
											</li>
