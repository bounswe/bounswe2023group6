					...
					<div className='w-full flex justify-center p-8 bg-neutral-50 pb-20'>
						<div className='w-9/10 flex flex-col'>
							<div className='flex m-4'>
								<p className='text-neutral-600 mt-4'>Page created on: {new Date(game?.creationDate).toLocaleDateString()}</p>
							</div>
									...
									<div className='card compact bg-neutral-200 text-cyan-700 shadow-xl m-2 p-4'>
										<div className='flex'>
											...
											<div className='w-3/5'>
												...
												<br />
												<p className='text-neutral-700'>Release Year: <b>{game?.releaseYear}</b></p>
											</div>
										</div>
									</div>
									<div className='w-full flex flex-row'>
									...
									<div className='h-full card compact bg-neutral-200 text-cyan-700 shadow-xl m-2 p-4'>
										...
										<div className='flex flex-wrap'>
											{game?.platforms.map((platform, index) => (
												<p key={index} className='text-neutral-700 border-b-2 border-neutral-400 p-2'>{platform}</p>
											))}
										</div>
