							...
							<div className='w-full flex flex-row'>
										...
										<div className='flex'>
											...
											<div className='w-3/5'>
												...
												<p className='text-gray-700 text-justify'>
													FIFA 23 is one of the most popular football simulation games developed by EA Sports. It
													offers an immersive gaming experience with realistic graphics, player mechanics, and
													stadiums. The game features various modes including career mode, ultimate team, and
													volta football, providing a diverse range of experiences for all football enthusiasts.
												</p>
												<br />
									...
									<div className='w-full flex flex-row'>
										...
										<div className='w-1/2 card compact bg-gray-50 text-sky-800 shadow-xl m-1 p-4'>
											...
											<div className='flex flex-wrap'>
												<Link to='/genre/football' className='text-blue-500 hover:underline mr-4'>
													Football
												</Link>
												<Link to='/genre/sports' className='text-blue-500 hover:underline mr-4'>
													Sports
												</Link>
											</div>
										</div>
								...
								<div className='w-2/5 flex flex-col'>
									<div className='h-full card compact bg-gray-50 text-sky-800 shadow-xl m-2 p-4'>
										...
										<p className='text-gray-700 border-b-2 border-gray-400 p-1'>
											PC, PS4, PS5, Xbox One, Xbox Series X/S
										</p>
										<h2 className='text-2xl font-bold p-1'>Games You May Like:</h2>
										<ul className='border-b-2 border-gray-400 p-1'>
											<li className='mb-2'>
												<Link to='/content/fifa-22' className='text-blue-500 hover:underline'>
													FIFA 22
												</Link>
											</li>
											<li className='mb-2'>
												<Link to='/content/uefa-euro-2020' className='text-blue-500 hover:underline'>
													UEFA Euro 2020
												</Link>
											</li>
											<li className='mb-2'>
												<Link to='/content/football-manager-2022' className='text-blue-500 hover:underline'>
