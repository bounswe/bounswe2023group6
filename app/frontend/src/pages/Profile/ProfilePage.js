            ...
            <div className='w-4/5 flex flex-col p-5 justify-center items-center'>
                <div className="compact text-[#FFF4E0] bg-[#4D4D4D]  text-sky-800 shadow-xl  p-4 flex w-4/5 h-1/4 mb-2 rounded-xl">
                    ...
                    <div className="w-2/3">
                        ...
                        <div className="h-0.7">
                            <h1 className="text-3xl mb-2">Mahmut Demir</h1>
                ...
                <div className="compact text-[#FFF4E0] bg-[#4D4D4D] text-sky-800 shadow-xl  p-4  w-4/5  h-1/6 mb-2 rounded-xl">
                    ...
                    <p>Greetings fellow gamers!  As an avid player navigating the vast landscapes of virtual worlds, I
                        find joy in the pixels and excitement in the ever-evolving narratives of video games. From
                        intense battles in fantasy realms to strategic maneuvers in competitive arenas, gaming has
                        become my digital sanctuary.
                    </p>
                </div>
